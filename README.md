...
- **Understand six essential file formats:** CSV, HTML, JSON, Markdown, Python, and YAML
...
- **Use AI tools effectively** as coding partners
...
- **Some patience** -  Willingness to experiment, and some persistence

**Before Class 1:**
1. Choose an AI chatbot, and make an account: [Claude](https://claude.ai), [ChatGPT](https://chat.openai.com), or [Gemini](https://gemini.google.com)
...
6. Python packages will be automatically installed
